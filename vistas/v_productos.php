      ...
      <form id="formProductos">
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-floating mb-3">
                <input type="number" step="any" class="form-control" name="costoProducto" id="costoProducto" placeholder="Costo">
                <label>Costo</label>
              </div>
            </div>
            <div class="col-md-4 mb-3">
              <div class="input-group">
                <div class="form-floating">
                  <input type="number" step="any" class="form-control" name="precioProducto" id="precioProducto" placeholder="Precio">
                  <label>Precio</label>
                </div>
            ...
            <div class="col-md-4">
              <div class="form-floating mb-3">
                <input type="number" step="any" class="form-control" name="precioMayoreoProducto" id="precioMayoreoProducto" placeholder="Precio Mayoreo">
            ...
            <div class="col-md-4">
              <div class="form-floating mb-3">
                <input type="number" step="any" class="form-control" name="stockMinimoProducto" id="stockMinimoProducto" placeholder="Stock Mínimo">
                <label>Stock Mínimo</label>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-floating mb-3">
                <input type="number" step="any" class="form-control" name="stockMaximoProducto" id="stockMaximoProducto" placeholder="Stock Máximo">
