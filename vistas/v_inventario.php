          ...
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              <div class="form-floating">
                <input type="number" step="any" class="form-control" id="cantidadInventario" name="cantidadInventario" placeholder="Cantidad">
      ...
      <div class="modal-body">
        <form id="formInventarioRes">
          <div class="row">
            ...
            <div class="col-md-12 mb-3">
              <div class="form-floating">
                <input type="number" step="any" class="form-control" id="cantidadInventarioRes" name="cantidadInventarioRes" placeholder="Cantidad">
  ...
  <div class="modal-dialog modal-xl modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12 text-end">
            <button type="button" class="btn btn-sm btn-primary " id="bNuevaMerma" title="Agregar Merma" >Agregar<i class="fa-solid fa-plus"></i></button>    
          </div>
        </div>
        <div class="row">
          <div class="col-12 table-responsive">
