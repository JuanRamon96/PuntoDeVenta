function v_proveedores() {
    ...
    $('#formProveedores').validate({
        ...
        messages: {
          ...
          emailProveedor: {
            email: "Intoduce un email valido."
          },
          telefonoProveedor: {
...
function guardarProveedor() {
    var data = "metodo="+$("#bGuardarProveedor").attr('tipo')+"&accion=proveedores&razon="+$.trim($("#razonProveedor").val())+"&rfc="+$.trim($("#rfcProveedor").val())+"&telefono="+$.trim($("#telefonoProveedor").val())+"&segundoTelefono="+$.trim($("#segundoTelProveedor").val())+"&email="+$.trim($("#emailProveedor").val())+"&credito="+$("#creditoProveedor").val()+"&contacto="+$.trim($("#contactoProveedor").val())+"&puesto="+$.trim($("#puestoProveedor").val())+"&telefonoContacto="+$.trim($("#telefonoContactoProveedor").val())+"&emailContacto="+$.trim($("#emailContactoProveedor").val())+"&calle="+$.trim($("#calleProveedor").val())+"&noExterior="+$.trim($("#noExteriorProveedor").val())+"&noInterior="+$.trim($("#noInteriorProveedor").val())+"&colonia="+$.trim($("#coloniaProveedor").val())+"&cp="+$.trim($("#cpProveedor").val())+"&ciudad="+$.trim($("#ciudadProveedor").val())+"&estado="+$.trim($("#estadoProveedor").val())+"&pais="+$.trim($("#paisProveedor").val())+"&clabe="+$.trim($("#clabeProveedor").val())+"&banco="+$.trim($("#bancoProveedor").val())+"&titular="+$.trim($("#titularProveedor").val())+"&id="+$("#bGuardarProveedor").attr('attrID');
...
jQuery(document).ready(function ($) {
  ...
  $(document).on('click', '.bModificarProveedor', function () {
      ...
      .done(function (res) {
        ...
        $("#creditoProveedor").val(datos.Credito);
