        ...
        Swal.fire({
          ...
          confirmButtonText: '¡Si, agregar!'
            ...
            if (result.value) {
              ...
              var data = "metodo=modificar&accion=inventario&id="+$('#bGuardarInventario').attr('attrID')+"&cantidad="+$("#cantidadInventario").val()+"&sucursal="+$("#sucursalInventario").val()+"&aplicar="+aplicar;
        ...
        Swal.fire({
          ...
          confirmButtonText: '¡Si, restar!'
            ...
            if (result.value) {
              ...
              var data = "metodo=eliminar&accion=inventario&id="+$('#bGuardarInventarioRes').attr('attrID')+"&cantidad="+$("#cantidadInventarioRes").val()+"&sucursal="+$("#sucursalInventarioRes").val()+"&aplicar="+aplicar;
