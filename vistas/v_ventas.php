        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-12 col-sm-12 mb-1">
              <center><h4 style="font-weight: bold;">Total de la venta: <br><span class="dinero" id="totalVentaPago"></span></h4></center>
            </div>
            <div class="col-md-12 col-sm-12 mb-1">
              <center><h4 style="font-weight: bold;">Total de pagos: <br><span class="dinero" id="pagosVenta"></span></h4></center>
            </div>
            <div class="col-md-12 col-sm-12 mb-1">
              <center><h4 style="font-weight: bold;">Restante: <br><span class="dinero" id="restanteVenta"></span></h4></center>
            </div>
            <div class="col-md-12 col-sm-12 mb-3">
              <div class="form-floating">
                <input type="number" class="form-control" min='1' step="any" id="importePagoVenta" name="importePagoVenta" placeholder="Ingresa el importe a pagar">
            ...
            <table class="table table-striped table-hover text-center" id="tablaModiVenta" width="100%">
              ...
              <tfoot style="font-size: 20px;">
                ...
                <tr>
                  ...
                  <td>
                    <div class="input-group input-group-sm">
                      <input type="number" class="form-control" value="0" step="any" id="porcentajeDescuentoModiVenta" placeholder="Porcentaje">
                      <span class="input-group-text">% = $</span>
                      <input type="number" class="form-control" value="0" step="any" id="cantidadDescuentoModiVenta" placeholder="Cantidad">
                    </div>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="number" class="form-control" id="pagoModiVenta" name="pagoModiVenta" placeholder="Pago"></td>
                </tr>
                <tr>
