<div class="row" style="margin-bottom: 30px; margin-top: -50px;">
  <div class="col-12 text-right">
    <button type="button" class="btn btn-sm btn-outline-danger cargarVista" carga="v_facturas" titulo="Facturas" id="bRecargarVFacturas"><i class="fas fa-rotate-right"></i></button>
  </div>
</div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <div class="card-body">
          <div class="row mb-3">
            <div class="col-12 text-end">
              <h5 class="text-muted">Timbres disponibles: <span class="cantidad text-success fs-2">#timbresDisponibles#</span></h5>
              <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modalTimbres"><i class="fas fa-dollar-sign"></i> Comprar Timbres</button>
            </div>
          </div>
          <div class="row">
                ...
                <div class="card" style="box-shadow: none; border: 1px solid #EEE;">
                  ...
                  <div class="card-body row">
                    ...
                    <div class="col-md-4 d-none">
                      ...
                      <select name="periodicidad" id="periodicidad" class="form-select mb-2" readonly>
                    ...
                    <div class="col-md-4 d-none">
                      ...
                      <select name="mes" id="mes" class="form-select mb-2" readonly>
                    ...
                    <div class="col-md-4 d-none">
                      ...
                      <input type="number" name="anio" id="anio" class="form-control mb-2" value="#anioActual#" readonly>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" id="c_cantidad" class="form-control calcConcepto" value="1">
            </div>

            <div class="col-md-4 mb-3">
              <label>Precio Unitario</label>
              <input type="text" id="c_precio" class="form-control calcConcepto">
            </div>

            <div class="col-md-6 mb-3">
              <label>Descuento (%)</label>
              <input type="text" id="c_descuento_porcentaje" class="form-control">
            </div>

            <div class="col-md-6 mb-3">
              <label>Descuento ($)</label>
              <input type="text" id="c_descuento_dinero" class="form-control">
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <input type="text" id="imp_tasa" class="form-control" placeholder="Cantidad Tasa / Cuota">
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" id="p_parcialidad" class="form-control" value="1" required>
            </div>

            <div class="col-md-4 mb-3">
              <label class="text-primary">Saldo Anterior</label>
              <input type="text" id="p_saldo_ant" class="form-control calcPago" required>
            </div>
            <div class="col-md-4 mb-3">
              <label class="text-success">Importe Pagado</label>
              <input type="text" id="p_monto_pagado" class="form-control calcPago" required>
            </div>
            <div class="col-md-4 mb-3">
              <label class="text-danger">Saldo Insoluto</label>
              <input type="text" id="p_saldo_insoluto" class="form-control" readonly>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3">
              <input type="text" id="p_imp_tasa" class="form-control" placeholder="Cantidad Tasa / Cuota">
            </div>
          </div>
...
<!-- ///////////////////////////Modal Timbres/////////////////////////////////// -->
<div id="modalTimbres" class="modal fade">
	<div class="modal-dialog modal-xl modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="modalTimbresLabel">Paquetes de Timbres</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-12 text-center">
						<h2>Elige el paquete de timbres que mejor se adapte a tu volumen de facturación.</h2>
					</div>
				</div>
				<div class="row mb-4">
					<div class="col-12 text-center">
						<p class="m-0 fs-6">
							Si tienes dudas o deseas realizar la compra de tu paquete, ponte en contacto con soporte.
						</p>
						<div class="alert alert-warning text-center" role="alert">
							<i class="fas fa-exclamation-triangle"></i> Los precios están sujetos al proveedor de timbres, por lo que pueden variar de tiempo en tiempo sin previo aviso.
						</div>
					</div>
				</div>
				<div class="row text-center">
					<div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">100 Timbres</h3>
								<div>
									<h1>$160.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Ideal para <b>negocios pequeños</b></li>
										<li><span class="chk">✓</span> Sin vencimiento por uso mensual</li>
									</ul>
									<a href="https://wa.me/523481167983?text=Hola%2C%20quiero%20comprar%20el%20paquete%20de%20100%20timbres%20para%20Ventas%20Tool"
					...
					<div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">200 Timbres</h3>
								<div>
									<h1>$300.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Para negocios con <b>venta constante</b></li>
										<li><span class="chk">✓</span> Sin vencimiento por uso mensual</li>
									</ul>
									<a href="https://wa.me/523481167983?text=Hola%2C%20quiero%20comprar%20el%20paquete%20de%20200%20timbres%20para%20Ventas%20Tool"
										target="_blank" class="btn btn-success">
										<i class="fab fa-whatsapp"></i> Contactar a soporte
									</a>
								</div>
					...
					<div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">500 Timbres</h3>
								<div>
									<h1>$735.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Mejor <b>precio por timbre</b></li>
										<li><span class="chk">✓</span> Sin vencimiento por uso mensual</li>
									</ul>
									<a href="https://wa.me/523481167983?text=Hola%2C%20quiero%20comprar%20el%20paquete%20de%20500%20timbres%20para%20Ventas%20Tool"
										target="_blank" class="btn btn-success">
										<i class="fab fa-whatsapp"></i> Contactar a soporte
									</a>
								</div>
					...
					<div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">1,000 Timbres</h3>
								<div>
									<h1>$1,460.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Para <b>alto volumen</b> de facturación</li>
										<li><span class="chk">✓</span> Sin vencimiento por uso mensual</li>
									</ul>
									<a href="https://wa.me/523481167983?text=Hola%2C%20quiero%20comprar%20el%20paquete%20de%201000%20timbres%20para%20Ventas%20Tool"
										target="_blank" class="btn btn-success">
										<i class="fab fa-whatsapp"></i> Contactar a soporte
									</a>
								</div>
					...
					<div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">2,000 Timbres</h3>
								<div>
									<h1>$2,910.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Para <b>alto volumen</b> de facturación</li>
									...
									<a href="https://wa.me/523481167983?text=Hola%2C%20quiero%20comprar%20el%20paquete%20de%202000%20timbres%20para%20Ventas%20Tool"
										target="_blank" class="btn btn-success">
										<i class="fab fa-whatsapp"></i> Contactar a soporte
									</a>
								</div>
          ...
          <div class="col-lg-4">
						<div class="card mb-4 ticket-precio">
							<div class="card-body">
								<h3 class="card-title">5,000 Timbres</h3>
								<div>
									<h1>$7,260.00 MXN</h1>
									<ul class="listaPlan">
										<li><span class="chk">✓</span> Para <b>alto volumen</b> de facturación</li>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-danger btn-lg btn-sm" data-bs-dismiss="modal"><i class="fas fa-times"></i> Cancelar</button>
			</div>
		</div>
	</div>
</div>