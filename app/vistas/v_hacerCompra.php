                    ...
                    <div class="col-md-3 text-center mb-2">
                        <div id="ponerDescuento">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="0" class="form-control" id="descuentoCompraDinero" name="descuentoCompraDinero" placeholder="$0.00">
                            </div>
                        </div>
                    </div>
	            ...
	            <div class="modal-body">
	       	       <div class="row">
                        ...
                        <div class="col-12 mb-3">
	       		        ...
	       		        <div class="col-12 mb-3">
                            <div class="form-floating">
                                <input type="text" value="0" class="form-control" id="importePagadoCobrar" name="importePagadoCobrar" placeholder="Ingresa el importe a pagar">
