...
function v_cajas() {
  ...
  montoCaja = IMask(
    document.getElementById('montoCaja'),
    {
      mask: Number,
  ...
  $('#formAbrirCaja').validate({
    ...
    errorElement: 'div',
    submitHandler: function(form) {
      var data = "metodo=insertar&accion=cajas&tipo=abrir&fkCaja="+$('#bAbrirMontoCaja').attr('attrID')+"&montoCaja="+$("#montoCaja").val().replaceAll(',', '');
...
function guardarCaja() {
  var data = "metodo="+$('#bGuardarCaja').attr('tipo')+"&accion=cajas&tipo=guardarCaja&idCaja="+$('#bGuardarCaja').attr('attrID')+"&nombreCaja="+$.trim($("#nombreCaja").val())
  +"&detallesCaja="+$.trim($("#detallesCaja").val())+"&sucursal="+$("#sucursalCaja").val();
