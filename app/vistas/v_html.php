...
<body class="bodyMenu">
		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div ">
				<div class="main-menu-header">
					<img class="img-radius" width="50" height="50" src="#fotoCuenta#" id="imagenPerfil"
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
		...
		<div class="m-header">
			...
			<a href="javascript:void(0)" class="pop-search btn btn-outline-secondary btn-sm" id="bAbrirCaja"><i
					class="fas fa-cart-shopping"></i> Caja</a>
				...
				<li>
					<div class="dropdown drp-user">
						...
						<div class="dropdown-menu dropdown-menu-right profile-notification">
							...
							<ul class="pro-body">
								<li><a href="javascript:void(0)" class="dropdown-item cargarVista"
										carga="v_configuracion" titulo="Configuración" id="bMenuConfiguracion"><i
											class="feather icon-settings"></i> Configuración</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item" id="bCerrarSe"><i
											class="feather icon-lock"></i> Cerrar Sesión</a></li>
							</ul>
						</div>
					</div>
				</li>
						...
						<div class="col-md-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="javascript:void(0)"
										class="vistaTitulo">Productos</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="modalCaja" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-modal="true"
				...
				<div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
					<div class="row">
						...
						<div class="col-md-6 text-end">
							<button type="submit" class="btn btn-outline-secondary btn-sm bCorteCaja" id="bCorteCaja"
								style="z-index: 1;">Hacer corte <i class="fas fa-calculator"></i></button>
							<button type="submit" class="btn btn-outline-secondary btn-sm bDejarCaja" id="bDejarCaja"
								style="z-index: 1;">Dejar caja <i class="fas fa-times"></i></button>
						</div>
						<form id="formAgreProd" class="row" autocomplete="off">
							<div class="col-md-5 col-sm-7">
								<div class="input-group mb-3">
									<span class="input-group-text"><i class="fas fa-barcode"></i></span>
									<input type="text" class="form-control" placeholder="Código" name="barCodeV"
										id="barCodeV" autocomplete="off" required autofocus>
								</div>
							</div>
							<div class="col-md-4 col-sm-5 mb-3 d-grid">
								<button type="submit" class="btn btn-outline-danger" id="bEnterBarCode">Enter/Agregar
									Producto <i class="fas fa-check"></i></button>
							</div>
						</form>
						<div class="row" id="mosBotonesCajaUP">
							<div class="col-12 mb-3">
								<div class="btn-group btn-group-sm" role="group">
									<button type="button" class="btn btn-outline-secondary" id="bIntVarios"><b>F2</b> <i
											class="fas fa-clipboard"></i> Insert. Varios</button>
									<button type="button" class="btn btn-outline-secondary" id="bProdComun"><b>ALT +
											C</b> <i class="fas fa-file"></i> Prod. Común</button>
									<button type="button" class="btn btn-outline-secondary" id="bBuscarProd"><b>F10</b>
										<i class="fas fa-search"></i> Buscar</button>
									<button type="button" class="btn btn-outline-secondary" id="bMayoreo"><b>F9</b> <i
											class="fas fa-certificate"></i> Mayoreo</button>
									<button type="button" class="btn btn-outline-secondary" id="bEntrada"><b>F7</b> <i
											class="fas fa-plus"></i> Entrada</button>
									<button type="button" class="btn btn-outline-secondary" id="bSalida"><b>F8</b> <i
											class="fas fa-minus"></i> Salida</button>
									<button type="button" class="btn btn-outline-secondary" id="bHacerDescuento"><b>ALT
											+ D</b> <i class="fas fa-percent"></i> Descuento</button>
									<button type="button" class="btn btn-outline-secondary"
										id="bQuitarProducto"><b>DEL</b> <i class="fas fa-trash"></i> Quitar
										Prod.</button>
								</div>
							</div>
						</div>
							...
							<div class="col-12" id="mosTiketsCaja">
								<nav>
									<div class="nav nav-tabs" id="navtabTickets" role="tablist">
										<button class="nav-link active" id="tab_ticket_1" data-bs-toggle="tab"
											data-bs-target="#nav_ticket_1" type="button" role="tab"
											aria-selected="true">Ticket 1</button>
									</div>
								</nav>
								<div class="tab-content" id="nav-tabContent">
									<div class="tab-pane fade show active" id="nav_ticket_1" role="tabpanel"
										aria-labelledby="nav-home-tab">
										<div class="row">
											<div class="col-12 table-responsive"
												style="height: 40vh; background-color:#F0F0F0;"
												id="mostrarTablaProdCaja">
												<table class="table table-hover table-striped text-center"
													id="tablaCaja" style="width: 100%; font-size: 12px;">
													<thead>
														<tr>
															<th>Código</th>
															<th>Descripción</th>
							...
							<div class="col-12">
								<div class="row mb-3">
									<div class="col-md-10 col-sm-8">
										<div class="row">
											<div class="col-12">
												<h6 class="text-muted"><b class="cantidad" id="cantidadCajaProd">0</b>
													Productos en la venta actual</h6>
											</div>
										</div>
										<div class="row">
											<div class="col-md-9 col-sm-8">
												<div class="btn-group btn-group-sm" role="group">
													<button type="button" class="btn btn-outline-secondary"
														id="bTicketPendiente"><b>F3</b> <i class="fas fa-thumbtack"></i>
														Pendiente</button>
													<button type="button" class="btn btn-outline-secondary"
														id="bCambiarTicket"><b>F6</b> <i
															class="fas fa-exchange-alt"></i> Cambiar</button>
													<button type="button" class="btn btn-outline-secondary"
														id="bEliminarTicket"><b>ALT + E</b> <i class="fas fa-trash"></i>
														Eliminar</button>
													<button type="button" class="btn btn-outline-secondary"
														id="bAgregarClienteBusN" attrID="" attrDireccion="">Agregar un
														cliente <i class="fas fa-plus"></i></button>
													<div class="form-check form-switch ml-4 mt-1">
														<input type="checkbox" class="form-check-input"
															id="bCambiarTouch">
														<label class="form-check-label"
															for="bCambiarTouch">Touch</label>
													</div>
												</div>
											</div>
											<div class="col-md-3 col-sm-4 d-grid">
												<button type="button" id="bCobrar" class="btn btn-secondary btn-lg">F12
													<i class="fas fa-cart-plus"></i> Cobrar</button>
											</div>
										</div>
									</div>
									<div class="col-md-2 col-sm-4"
										style="background-color: #E9E9E9; color: blue; padding-top: 5px;">
										<p class="text-center" style="margin: 0; color: #606060;"><b>Subtotal: <span
													id="subtotalCaja" class="dinero">0</span></b></p>
										<p class="text-center" style="margin: 0;"><b>Descuento: <span id="mosDesGeP"
													class="porcentaje">0</span> (<span id="mosDesGeD"
													class="dinero">0</span>)</b></p>
								...
								<div class="row mb-3">
									<div class="col-12 text-end">
										<div class="btn-group btn-group-sm" role="group">
											<button type="button" class="btn btn-outline-secondary"
												id="bDescuentoGeneral"><b>ALT + G</b> % Descuento General</button>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MGranel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		...
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
					...
					<form id="formGranel">
						<div class="input-group mb-3">
							<div class="form-floating">
								<input type="text" class="form-control" name="cantidadGranel" id="cantidadGranel"
									placeholder="Cantidad" value="1.00">
								<label for="floatingInput">Cantidad</label>
							</div>
							<button type="button" class="btn btn-outline-secondary" type="button"
								id="bOptenerPeso">Pesar <i class="fa-solid fa-weight-scale"></i></button>
							<button type="button" class="btn btn-outline-secondary" type="button"
								id="bConectarBascula">Conectar Bascula</button>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="importeGranel" id="importeGranel"
								placeholder="Importe">
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bAgregarGranel">Agregar <i
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MIntVarios" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formIntVarios">
						<div class="input-group mb-3">
							<span class="input-group-text"><i class="fas fa-barcode"></i></span>
							<input type="text" class="form-control" placeholder="Código" name="barCodeIntVatios"
								id="barCodeIntVatios">
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="cantidadIntVatios" id="cantidadIntVatios"
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bAgregarVarios">Agregar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MProdComun" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formProdComun">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="descripcionProdComun"
								id="descripcionProdComun" placeholder="Descripción">
							<label for="floatingInput">Descripción</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="cantidadProdComun" id="cantidadProdComun"
								placeholder="Cantidad" value="1.00">
							<label for="floatingInput">Cantidad</label>
						</div>
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="precioProdComun" id="precioProdComun"
								placeholder="Precio">
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bAgregarProdComun">Agregar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MBuscarProd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12 text-end">
							<button class="btn btn-secondary btn-sm" id="bRecargarBusquedaProductos" type="button"><i
					...
					<div class="row">
						<div class="col-12 table-responsive">
							<table class="table table-striped text-center myDataTable" id="tablaBuscarProductos"
								width="100%">
								<thead>
									<tr>
										<th>Descripción</th>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MEntrada" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formEntrada">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="montoEntrada" id="montoEntrada"
								placeholder="Monto">
							<label for="floatingInput">Monto</label>
						</div>
						<div class="form-floating">
							<textarea class="form-control" id="descripcionEntrada" name="descripcionEntrada"
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bGuardarEntrada">Guardar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MSalida" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formSalida">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="montoSalida" id="montoSalida"
								placeholder="Monto">
							<label for="floatingInput">Monto</label>
						</div>
						<div class="form-floating">
							<textarea class="form-control" id="descripcionSalida" name="descripcionSalida"
								placeholder="Descripción" style="height: 100px"></textarea>
							<label for="floatingTextarea2">Descripción</label>
						</div>
					</form>
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bGuardarSalida">Guardar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MDescuento" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					...
					<p class="h3 mb-3 text-center dinero" id="totalDescuento"></p>
					<form id="formDescuento">
						<div class="input-group mb-3">
							<input type="text" value="0" class="form-control" id="porcentajeDescuentoCaja"
								placeholder="Porcentaje" aria-label="Porcentaje">
							<span class="input-group-text">% = $</span>
							<input type="text" value="0" class="form-control" id="cantidadDescuentoCaja"
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bGuardarDescuento">Guardar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MPendiente" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formPendiente">
						<div class="form-floating mb-3">
							<input type="text" class="form-control" name="nombrePendiente" id="nombrePendiente"
								placeholder="Nombre">
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bGuardarPendiente">Guardar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MCambiarTicket" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-primary" id="bTabCambiarTicket">Cambiar <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MCobrar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="formCobrar" class="row">
						<div class="col-12 mb-3" id="mosClienteCobrarCaja">
							<label>Cliente</label>
							<div class="input-group mb-3">
								<input type="text" class="form-control" id="clienteCobrar" name="clienteCobrar"
									placeholder="Publico en general" attrID="" attrDireccion="" disabled>
								<button type="button" class="btn btn-outline-secondary" id="bBuscarClienteCobrar">F2 <i
										class="fas fa-search"></i></button>
								<button type="button" class="btn btn-outline-secondary" id="bQuitarClienteCobrar"><i
										class="fas fa-times"></i></button>
							</div>
						</div>
						...
						<div class="col-12 mb-3">
							<div class="form-floating">
								<input type="text" class="form-control form-control-lg" id="totalPagoCobrar"
									name="totalPagoCobrar">
						...
						<div class="col-12 mb-3">
							<div class="form-floating">
								<textarea class="form-control" placeholder="Detalles" id="detallesCobrar"
									name="detallesCobrar" style="height: 80px"></textarea>
				...
				<div class="modal-footer text-center">
					<button type="reset" class="btn btn-outline-danger btn-lg" data-bs-dismiss="modal">Cerrar <i
							class="fas fa-times"></i></button>
					<button type="button" class="btn btn-secondary btn-lg" id="bSoloCobrar">F4 - Solo Completar <i
							class="fas fa-check"></i></button>
					<button type="button" class="btn btn-primary btn-lg" id="bCobrarImprimir">F1 - Completar e
						imprimir<i class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MCorteCaja" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6 ">
							...
							<div class="row">
								<div class="col-12 table-responsive">
									<table id="tablaDetallesBalance"
										class="table table0hover table-striped table-bordered text-center"
						...
						<div class="col-md-6 mb-3">
							...
							<div class="form-floating">
								<input type="text" class="form-control form-control-lg" id="montoCorte"
									name="montoCorte">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-12 table-responsive">
									<table id="tablaTotalVentasUsuarios"
										class="table table-hover table-striped table-bordered table-fixed text-center"
										style="font-size: 18px;" width="100%">
										<thead>
											<tr>
												<th>Usuario</th>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-12 table-responsive">
									<table id="tablaTotalPagosCompras"
										class="table table-hover table-striped table-bordered table-fixed text-center"
										style="font-size: 18px;" width="100%">
										<thead>
											<tr>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-12 table-responsive">
									<table id="tablaTotalPagosVentas"
										class="table table-hover table-striped table-bordered text-center"
										style="font-size: 18px;" width="100%">
										<thead>
											<tr>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-12 table-responsive">
									<table id="tablaDetallesPagosVentas"
										class="table table-hover table-striped table-bordered table-fixed text-center"
										style="font-size: 18px;" width="100%">
										<thead>
											<tr>
				...
				<div class="modal-footer text-center">
					...
					<button type="button" class="btn btn-primary btn-lg" id="bHacerCorteImprimir">Hacer Corte <i
							class="fas fa-check"></i></button>
				</div>
			</div>
		</div>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MVentasPendientes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12 text-end">
							<button class="btn btn-secondary btn-sm" id="bRecargarVentasPendientes" type="button"><i
									class="fa-solid fa-rotate-right"></i></button>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-12 table-responsive">
							<table class="table table-striped text-center myDataTable" id="tablaVentasPendientes"
								width="100%">
								<thead>
									<tr>
										<th>Fecha</th>
	...
	<!-- ///////////////////////////Modal////////////////////////////// -->
	<div class="modal fade" id="MBuscarCliente" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
		aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12 text-end">
							<button class="btn btn-secondary btn-sm" id="bRecargarBusquedaClientes" type="button"><i
									class="fa-solid fa-rotate-right"></i></button>
						</div>
					</div>
					<br>
					<div class="row">
						<div class="col-12 table-responsive">
							<table class="table table-striped text-center myDataTable" id="tablaBuscarClientes"
								width="100%">
								<thead>
									<tr>
										<th>Nombre</th>
			...
			<div class="modal-content">
				...
				<form id="formCliente">
					<div class="modal-body">
						<div class="row">
							<div class="form-group col-md-6 mb-3" style="position: relative;">
								...
								<input type="text" class="form-control" id="telefonoClienteBus"
									name="telefonoClienteBus" autocomplete="off">
								<div class="listaInput oculto" id="telefonosClientesBus"></div>
							</div>
							<div class="form-group col-md-6 mb-3" style="position: relative;">
								<label>Nombre</label>
								<input type="text" class="form-control" id="nombreClienteBus" name="nombreClienteBus"
									autocomplete="off">
						...
						<div class="row oculto" id="seleccionDomicilioBus">
							<div class="form-group col-md-6 mb-4">
								...
								<select id="domicilioClienteBus" name="domicilioClienteBus" class="form-control"
									multiple="true">
						...
						<div class="row">
							...
							<div class="form-group col-md-6 mb-3">
								...
								<input type="text" class="form-control" id="noExteriorClienteBus"
									name="noExteriorClienteBus">
							</div>
							<div class="form-group col-md-6 mb-3">
								<label>No. Interior</label>
								<input type="text" class="form-control" id="noInteriorClienteBus"
									name="noInteriorClienteBus">
							</div>
							<div class="form-group col-md-6 mb-3">
							...
							<div class="form-group col-12 mb-3">
								<label>Detalles</label>
								<textarea name="detallesClienteBus" id="detallesClienteBus" rows="3"
									class="form-control">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-outline-danger btn-lg" data-bs-dismiss="modal"><i
								class="fas fa-times"></i> Cerrar</button>
						<button type="submit" class="btn btn-primary btn-lg" id="bAceptarClienteBus"><i
	...
	<!-- ///////////////////////////Modal Suscripción/////////////////////////////////// -->
	<div id="modalSuscripcion" class="modal fade">
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12 text-center">
							<h2>Puedes renovar tu suscripción eligiendo uno de nuestros planes y precios.</h2>
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-12 text-center">
							...
							<div class="alert alert-warning text-center" role="alert">
								<i class="fas fa-exclamation-triangle"></i> Los pagos con factura tienen un cargo
								adicional del 16% de IVA.
							</div>
							<p class="m-0 fs-6">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-outline-danger btn-lg btn-sm" data-bs-dismiss="modal"><i
	...
	<!--Live-->
	<script
		src="https://www.paypal.com/sdk/js?client-id=ARSS_P46LzNOJiIj32nIVdBiCqiWZJiwtlA8AU3q9e6nZbVDEI4R1C8mciFIxsM1xsgcQz6rNPiElJsC&currency=MXN"></script>
